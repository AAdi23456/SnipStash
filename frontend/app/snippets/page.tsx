...
import { CheckCircle2, Code, Copy, Edit, Folder, FolderClosed, PlusCircle, Search, Filter } from 'lucide-react';
      ...
      <div className="container p-4 md:p-6 mx-auto">
        <div className="flex flex-col md:flex-row justify-between mb-6 gap-4">
          <div>
            ...
            <p className="text-muted-foreground">Manage and view all your saved code snippets</p>
          </div>
                ...
                <Card key={snippet.id} className="overflow-hidden h-full flex flex-col">
                  <CardHeader className="pb-2">
                    <div className="flex justify-between items-start">
                      <CardTitle className="text-xl truncate">{snippet.title}</CardTitle>
                  ...
                  <CardContent>
                    <div className="bg-muted rounded-md p-2 font-mono text-xs overflow-hidden whitespace-pre-wrap line-clamp-4">
                      {snippet.code}
                    </div>
                  ...
                  <CardFooter className="mt-auto border-t pt-4 flex flex-col gap-2 items-start">
